...
public class Sounds {
    ...
    public static final SoundSettings GET_ITEM = SoundSettings.of(Sound.ENTITY_HORSE_SADDLE, 0.25f, 1, SoundCategory.PLAYERS, PlayType.PLAYER);
    ...
    public static final SoundSettings MENU_GET_ITEM = SoundSettings.of(Sound.ITEM_BUNDLE_REMOVE_ONE, 1f, 1, SoundCategory.PLAYERS, PlayType.PLAYER);
    ...
    public static final SoundSettings ITEM_BREAK = SoundSettings.of(Sound.ENTITY_ITEM_BREAK, 0.5f, 1f, SoundCategory.PLAYERS, PlayType.BROADCAST_CUR_LOC);
    public static final SoundSettings BLOCK_RETURN = SoundSettings.of(Sound.ENTITY_CHICKEN_EGG, 0.33f, 1f, SoundCategory.BLOCKS, PlayType.BROADCAST_CUR_LOC);
}